	...
	<div class="limiter">
		...
		<div class="container-login100" style="background-image: url(${pageContext.request.contextPath}/images/bg-01.jpg);">
			...
			<a href="AT_web_vs_csdl/login.htm" class="quay" style="color: white;font-size: 30px; margin-left: -40px;top: -60px;">&#x21e6;</a>
				<form class="login100-form validate-form" method="post" action="AT_web_vs_csdl/resetpass.htm">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" type="email" name="reset" placeholder="Email" autocomplete="off" required="required" >
